class EndUser < ApplicationRecord
  ...
  has_many :studio_reviews, dependent: :destroy ## スタジオのレビューとのリレーション記述、ユーザーが削除されればレビューは削除される
                                                                    
  has_many :store_reviews,  dependent: :destroy ## 店舗レビューとのリレーション記述、ユーザーが削除されればレビューは削除される
end
